 ...
 * TODO comments
 */
class GeocoderService_Nominatim implements GeocoderService
{
    public function servicepollaction ($searchstring, $searchstringShort, $uri)
    {
        ...
        */
        $contactEmail = ''; // <= Enter your e-mail here
        ...
        while (isset($result[$resultcounter]) && $resultcounter < 10) {
            ...
            $data[$resultcounter]['service_accuracy'] =
                $result[$resultcounter]['class'] . $result[$resultcounter]['type'];
